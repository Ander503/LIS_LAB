...
<head>
    ...
    <script>
        $(document).ready(function(){
            $('.responsive').not('table').resposiveText();
            $('table.responsive').resposiveTables();
        });
    </script>
</head>
<body>
    ...
    <section>
        ...
        echo "<article>";
        echo "<p>\n";
        echo "Esta iteracion sencilla con: ";
        echo "<em>do-while</em> imprime una serie de ";
        echo "20 numeros enteros\n";
        echo "</p>\n";
        echo "<table class=\"responsive\" data-min=\"11\" data-max=\"30\" cellpadding=\"0\" celspacing=\"0\">\n";
        echo "\t<tbody>\n";
        echo "\t\t<tr>\n";
        do{
            echo "<td>$min</td>\n";
        ...
        cellspacing=\"0\" >\n";
        echo "\t<tr>\n";
        echo "\t\t<td>El valor minimo de la serie es: </td>\n";
        echo "\t\t<td>$min</td>\n";
        ...
        echo "pares en este intervao es:\n</td>\n";
        echo "\t\t<td>$contador</td>\n";
        echo "</table>\n";
